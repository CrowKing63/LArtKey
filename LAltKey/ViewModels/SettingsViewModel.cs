...
public partial class SettingsViewModel : ObservableObject
{
    ...
    private LAltKey.Views.SettingsWindow? _settingsWindow;
    private LAltKey.Views.SwitchScanSettingsWindow? _switchScanSettingsWindow;
    private LAltKey.Views.FocusA11ySettingsWindow? _focusA11ySettingsWindow;
    ...
    private void OpenSettings()
    {
        ...
        _settingsWindow = new LAltKey.Views.SettingsWindow(this);
    ...
    private void OpenSwitchScanSettings()
    {
        ...
        _switchScanSettingsWindow = new LAltKey.Views.SwitchScanSettingsWindow(this);
    ...
    private void OpenFocusA11ySettings()
    {
        ...
        _focusA11ySettingsWindow = new LAltKey.Views.FocusA11ySettingsWindow(this);
        AuxiliaryWindowPlacement.CenterNear(
    ...
    private static void LaunchTools(string? toolName, string? extraArguments = null)
    {
        ...
        {
            WpfMsgBox.Show(
                "LAltKey.Tools could not be found.\n" +
                "Install the full package or place LAltKey.Tools.exe next to LAltKey.exe.",
                "LAltKey Tools",
                WpfMsgBoxButton.OK,
    ...
    /// <summary>
    /// Checks GitHub Releases for the latest LAltKey version.
    /// </summary>
    [RelayCommand]
    private async Task CheckForUpdate()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                ShowUpdateMessage($"LAltKey is up to date.\nCurrent version: {CurrentVersion}");
            }
        }
        catch (Exception ex)
        {
    ...
    private async Task DownloadAndInstallFromSettings()
    {
        ...
        try
        {
            ...
            var installerFileName = $"LAltKey-Setup-{LatestVersion}.exe";
            ...
            var result = WpfMsgBox.Show(
                $"LAltKey {LatestVersion} has been downloaded.\n\nThe app may close and restart during installation.\n\nInstall now?",
                "Install LAltKey update",
    ...
    {
        WpfMsgBox.Show(message, "LAltKey update", WpfMsgBoxButton.OK, WpfMsgBoxImage.Information);
    }
}
