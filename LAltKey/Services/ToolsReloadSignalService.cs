...
/// <summary>
/// [text] Handles lightweight reload signals between LAltKey.Tools and the main app.
/// [text] text.
/// [text] 1text.
/// </summary>
...
{
    // text.
    private const string ReloadLayoutsEventName = "LAltKey.Tools.ReloadLayouts";
    private const string ReloadUserDictionaryEventName = "LAltKey.Tools.ReloadUserDictionary";
    private const string ReloadBigramDataEventName = "LAltKey.Tools.ReloadBigramData";
    private const string ReloadProfilesEventName = "LAltKey.Tools.ReloadProfiles";
    private const string ReloadAiSettingsEventName = "LAltKey.Tools.ReloadAiSettings";
    private const string ReloadHeaderButtonsEventName = "LAltKey.Tools.ReloadHeaderButtons";
